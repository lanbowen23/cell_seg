...
config_vars["batch_size"] = 16
config_vars["val_batch_size"] = 16

# >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
# 02.03 DATA NORMALIZATION

config_vars["rescale_labels"] = True  # bit 8 change input from 255(skimage save) to 1?
...
config_vars["object_dilation"] = 3  #这样可以有更好的数值结果
